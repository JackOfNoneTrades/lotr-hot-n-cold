...
public final class ProductionGearScreen extends GuiScreen {
    ...
    public ProductionGearScreen(LOTREntityNPC npc) {
        this.npc = npc;
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredString(fontRendererObj, "Configured: " + helmet.getDisplayName(), width / 4, 20, 0xFFFFFF);
        ...
        if (!rendered) {
            ProductionFixture.LOG.info(
                ...
                ScreenShotHelper
                    .saveScreenshot(
                        mc.mcDataDir,
                        "equipment-preview.png",
                        mc.displayWidth,
                        mc.displayHeight,
                        mc.getFramebuffer())
                    .getUnformattedText());
            ProductionFixture.require(
                new java.io.File(mc.mcDataDir, "screenshots/equipment-preview.png").isFile(),
